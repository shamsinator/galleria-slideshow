...
const Dashboard = async () => {
  ...
  //     name: "Starry Night",
  //     year: 1889,
  //     description: "Although The Starry Night was painted during the day...",
  ...
  //     year: 1665,
  //     description:
  //       "The painting is a tronie, the Dutch 17th-century description of a 'head'...",
  ...
  //     name: "Guernica",
  //     year: 1937,
  //     description: "The scene occurs within a room where, on the left...",
